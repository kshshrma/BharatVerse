...
import { Search, MapPin, Mail, Phone, Heart, Globe, Users, Sparkles, Store, GraduationCap, Zap, ShieldCheck, Plus, MessageCircle, X } from "lucide-react";
  ...
  return (
    <div className="min-h-screen relative overflow-hidden">
      ...
      <section id="home" className="min-h-screen flex items-center justify-center pt-20 relative z-10">
        <motion.div className="container mx-auto px-4 py-20 md:py-32 text-center">
