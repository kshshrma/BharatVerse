          ...
          >
            ...
            {subscribers.length === 0 ? (
              ...
              <div className="space-y-3">
                ...
                {subscribers.map((sub) => (
                  <motion.div key={sub.id} className="transition-all hover:scale-[1.02]">
                    <Card className="glass-card border-border/30 hover:border-primary/50 shadow-lg">
        ...
        >
          ...
          {catchUps.length > 0 && (
            <div className="mb-10">
              ...
              <div className="space-y-3">
                {catchUps.map((c) => (
                  <motion.div key={c.subscription_id} className="transition-all hover:scale-[1.02]">
          ...
          {items.length === 0 && catchUps.length === 0 ? (
            ...
            <div className="space-y-4">
              {items.map((item) => (
                <motion.div key={item.id} className="transition-all hover:scale-[1.02]">
                  <Card className="glass-card border-border/30 hover:border-primary/50 shadow-lg relative overflow-hidden group">
                    <div className="absolute inset-0 bg-gradient-to-r from-transparent via-primary/5 to-transparent opacity-0 group-hover:opacity-100 -translate-x-[100%] group-hover:translate-x-[100%] transition-all duration-1000 ease-in-out" />
